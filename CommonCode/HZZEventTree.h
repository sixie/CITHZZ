...
class HZZEventTree {
 ...
 public:
  ...
  Float_t                 fLogLikelihood_scalar;
  Float_t                 fLogLikelihood_pseudoscalar;
 ...
 public:
  ...
  void InitVariables() {
    ...
    fLogLikelihood_scalar =  0.0;
    fLogLikelihood_pseudoscalar =  0.0;
  ...
  void CreateTree(){
    ...
    tree_->Branch("logLikelihood_scalar", &fLogLikelihood_scalar, "logLikelihood_scalar/F");
    tree_->Branch("logLikelihood_pseudoscalar", &fLogLikelihood_pseudoscalar, "logLikelihood_pseudoscalar/F");
  } 
  ...
  void InitTree(){
    ...
    tree_->SetBranchAddress("logLikelihood_scalar", &fLogLikelihood_scalar);
    tree_->SetBranchAddress("logLikelihood_pseudoscalar", &fLogLikelihood_pseudoscalar);
