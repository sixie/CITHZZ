...
float electroneMax[nElectronMAX];
 int electronscindex[nElectronMAX];
  ...
  //gen jets
  int nGenJets; 
  float etaGenJet[MAXGenSaved];
  float phiGenJet[MAXGenSaved];
  float ptGenJet[MAXGenSaved];
  float massGenJet[MAXGenSaved];
  float eGenJet[MAXGenSaved];
  float pxGenJet[MAXGenSaved];
  float pyGenJet[MAXGenSaved];
  float pzGenJet[MAXGenSaved];
  float pGenJet[MAXGenSaved];
  float hadEnergyGenJet[MAXGenSaved];
  float emEnergyGenJet[MAXGenSaved];
  float invisibleEnergyGenJet[MAXGenSaved];
  float auxiliaryEnergyGenJet[MAXGenSaved];
  ...
  vector<int> partonList; 
   ...
   // L1 objects
      ...
      bool applyGenLevelZPlusJetsM4LFilter;
