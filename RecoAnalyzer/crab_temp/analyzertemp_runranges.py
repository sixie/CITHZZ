...
process.source = cms.Source("PoolSource",
    ...
    'file:PhotonRun2011B-30Nov2011-v1AOD.175865_54_51988343.root'
...
process.GlobalTag.globaltag = 'TagName::All'
...
process.recoAnalyzer = cms.EDAnalyzer("RecoAnalyzer",
                                      outputFile = cms.string('analysis.maindataname.runMinToMax.root'),
                                      trigResultTag = cms.untracked.InputTag('TriggerResults','','hltProcName'),
                                           trigSummaryTag =  cms.untracked.InputTag('hltTriggerSummaryAOD','','hltProcName'),
...
process.pfjet = cms.Sequence(process.kt6PFJets * process.ak5PFJets)
process.pfjetpath = cms.Path(process.pfjet)

process.schedule = cms.Schedule(process.pfjetpath,process.rhopath2,process.out_step)
