...
//*************************************************************************************************
void plotRegressionVarianceComparison_2Dprofile(string applyingFilename, string targetFilename1, string targetFilename2, string versionOption1, string versionOption2, string outDirectoryName, Int_t Option) {  
  ...
  EleRegressionVariance_hists[0]->ProfileX()->Draw();
  ...
  cv = new TCanvas("cv", "cv", 800, 600);
  EleRegressionVariance_hists[1]->ProfileX()->Draw();
