...
void fillTH1F(string sname, float val, float wt=1.0){
  std::map<string,TH1F*>::iterator it_data2 = th1f_map.find(sname);
  if( it_data2 == th1f_map.end()){
...
void fillRootDataSetAndTH1F(string sname,float val, float wt, bool setHistwtOne=false){
