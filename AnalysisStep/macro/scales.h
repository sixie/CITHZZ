...
void initxsecweights() {
    ...
    xsecweights[200] = 18.14  * 1000.0 * 9.22e-5 / 296850.; 
    xsecweights[201] = 16.65  * 1000.0 * 1.67e-4 / 238879.;
    xsecweights[202] = 14.16  * 1000.0 * 4.14e-4 / 295356.;
    xsecweights[203] = 12.18  * 1000.0 * 7.11e-4 / 299973.;
    xsecweights[204] = 10.58  * 1000.0 * 8.50e-4 / 285262.;
    xsecweights[205] = 9.202  * 1000.0 * 4.25e-4 / 237830.;
    xsecweights[206] = 7.786  * 1000.0 * 2.41e-4 / 292891.;
    xsecweights[207] = 6.869  * 1000.0 * 6.12e-4 / 285581.;
    xsecweights[208] = 6.017  * 1000.0 * 2.12e-3 / 243498.;
    xsecweights[209] = 5.377  * 1000.0 * 2.59e-3 / 214799.;
    xsecweights[210] = 4.922  * 1000.0 * 2.78e-3 / 199978.;
    xsecweights[211] = 4.528  * 1000.0 * 2.87e-3 / 299075.;
    ...
    xsecweights[256] = 0.8163 * 1000.0 * 2.41e-4 / 49944.;
    xsecweights[257] = 0.7480 * 1000.0 * 6.12e-4 / 49357.;
    xsecweights[258] = 0.6925 * 1000.0 * 2.12e-3 / 49955.;
    xsecweights[259] = 0.6371 * 1000.0 * 2.59e-3 / 49938.;
    xsecweights[260] = 0.5869 * 1000.0 * 2.78e-3 / 49416.;
    xsecweights[261] = 0.5420 * 1000.0 * 2.87e-3 / 49936.;
...
void initmuonscalefactors() {
    ...
    std::string filepath = baseFolder + "/src/CITHZZ/AnalysisStep/data/scale_factors.26-05-12.root";
...
void initelectronscalefactors() {
    std::string baseFolder(getenv("CMSSW_BASE"));
    std::string filepath = baseFolder + "/src/CITHZZ/AnalysisStep/data/hel_sf_2011.root";
