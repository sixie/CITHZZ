...
class YieldMaker {
	...
	public :        
		...
		void get1DHist_z1mass(int channel, float z1min, float z2min, float m4lmin, float m4lmax, float melacut, TH1* hist) {
		  for (int i = 0; i < dataset.numEntries(); i++) {
		    float z1mass    = dataset.get(i)->getRealValue("z1mass");
		    float z2mass    = dataset.get(i)->getRealValue("z2mass");
		    float mass      = dataset.get(i)->getRealValue("mass");
		    ...
		    if (channel == (int)ch && z1mass>z1min && z1mass<120 && z2mass>z2min && z2min<120 && mass>m4lmin && mass<m4lmax && mela>melacut) hist->Fill(z1mass, weight);
		  }
		}

		void get1DHist_z2mass(int channel, float z1min, float z2min, float m4lmin, float m4lmax, float melacut, TH1* hist) {
		  for (int i = 0; i < dataset.numEntries(); i++) {
		    float z1mass    = dataset.get(i)->getRealValue("z1mass");
		    float z2mass    = dataset.get(i)->getRealValue("z2mass");
		    float mass      = dataset.get(i)->getRealValue("mass");
		    ...
		    if (channel == (int)ch && z1mass>z1min && z1mass<120 && z2mass>z2min && z2min<120 && mass>m4lmin && mass<m4lmax && mela>melacut) hist->Fill(z2mass, weight);
		  }
		}

		void get1DHist_mela(int channel, float z1min, float z2min, float m4lmin, float m4lmax, float melacut, TH1* hist) {
		  for (int i = 0; i < dataset.numEntries(); i++) {
		    float z1mass    = dataset.get(i)->getRealValue("z1mass");
		    float z2mass    = dataset.get(i)->getRealValue("z2mass");
		    float mass      = dataset.get(i)->getRealValue("mass");
		    ...
		    if (channel == (int)ch && z1mass>z1min && z1mass<120 && z2mass>z2min && z2min<120 && mass>m4lmin && mass<m4lmax && mela>melacut) hist->Fill(mela, weight);
		  }
		}
		...
		void get2DHist_zmass(int channel, float z1min, float z2min, float m4lmin, float m4lmax, float melacut, TH2* hist) {
		  ...
		  for (int i = 0; i < dataset.numEntries(); i++) {
		    ...
		    if (channel == (int)ch && z1mass>z1min && z1mass<120 && z2mass>z2min && z2min<120 && mass>m4lmin && mass<m4lmax && mela>melacut) hist->Fill(z1mass, z2mass, weight);
		  }
