...
void initmuonscalefactors() {
    ...
    std::string filepath = baseFolder + "/src/CITHZZ/AnalysisStep/data/mu_sf.root";
...
void initelectronscalefactors() {
    std::string baseFolder(getenv("CMSSW_BASE"));
    std::string filepath = baseFolder + "/src/CITHZZ/AnalysisStep/data/hel_sf_2012.root";
    //std::string filepath = baseFolder + "/src/CITHZZ/AnalysisStep/data/efficiency_results_EleHZZICHEP2012WP_Full2012.root";
