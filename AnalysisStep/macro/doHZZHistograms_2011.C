...
void analysisEngine(HiggsMassPointInfo hinfo, char* filename) {
  /*
     hinfo is the HiggsMassPointInfo with all the parameters called from main
     filename is the file where the histograms are to be outputted to
   */
  ...
  TH1F data_hist_mass("data_hist_mass", "Mass, all, data", 40, 100, 220);
  TH1F data_hist_mass_4m("data_hist_mass_4m", "Mass, 4m, data", 40, 100, 220);
  TH1F data_hist_mass_4e("data_hist_mass_4e", "Mass, 4e, data", 40, 100, 220);
  TH1F data_hist_mass_2e2m("data_hist_mass_2e2m", "Mass, 2e2m, data", 40, 100, 220);
  ...
  TH1F bkg_zxss_hist_mass("bkg_zxss_hist_mass", "Mass, all, ZX background", 40, 100, 220);
  TH1F bkg_zxss_hist_mass_4m("bkg_zxss_hist_mass_4m", "Mass, 4m, ZX background", 40, 100, 220);
  TH1F bkg_zxss_hist_mass_4e("bkg_zxss_hist_mass_4e", "Mass, 4e, ZX background", 40, 100, 220);
  TH1F bkg_zxss_hist_mass_2e2m("bkg_zxss_hist_mass_2e2m", "Mass, 2e2m, ZX background", 40, 100, 220);
  ...
  TH1F bkg_qqzz_hist_mass("bkg_qqzz_hist_mass", "Mass, all, qqZZ background", 40, 100, 220);
  TH1F bkg_qqzz_hist_mass_4m("bkg_qqzz_hist_mass_4m", "Mass, 4m, qqZZ background", 40, 100, 220);
  TH1F bkg_qqzz_hist_mass_4e("bkg_qqzz_hist_mass_4e", "Mass, 4e, qqZZ background", 40, 100, 220);
  TH1F bkg_qqzz_hist_mass_2e2m("bkg_qqzz_hist_mass_2e2m", "Mass, 2e2m, qqZZ background", 40, 100, 220);
  ...
  TH1F bkg_ggzz_hist_mass("bkg_ggzz_hist_mass", "Mass, all, ggZZ background", 40, 100, 220);
  TH1F bkg_ggzz_hist_mass_4m("bkg_ggzz_hist_mass_4m", "Mass, 4m, ggZZ background", 40, 100, 220);
  TH1F bkg_ggzz_hist_mass_4e("bkg_ggzz_hist_mass_4e", "Mass, 4e, ggZZ background", 40, 100, 220);
  TH1F bkg_ggzz_hist_mass_2e2m("bkg_ggzz_hist_mass_2e2m", "Mass, 2e2m, ggZZ background", 40, 100, 220);
  ...
  TH1F sig_ghzz_hist_mass("sig_ghzz_hist_mass", "Mass, all, gHZZ signal", 40, 100, 220);
  TH1F sig_ghzz_hist_mass_4m("sig_ghzz_hist_mass_4m", "Mass, 4m, gHZZ signal", 40, 100, 220);
  TH1F sig_ghzz_hist_mass_4e("sig_ghzz_hist_mass_4e", "Mass, 4e, gHZZ signal", 40, 100, 220);
  TH1F sig_ghzz_hist_mass_2e2m("sig_ghzz_hist_mass_2e2m", "Mass, 2e2m, gHZZ signal", 40, 100, 220);
  ...
  TH1F sig_qhzz_hist_mass("sig_qhzz_hist_mass", "Mass, all, qHZZ signal", 40, 100, 220);
  TH1F sig_qhzz_hist_mass_4m("sig_qhzz_hist_mass_4m", "Mass, 4m, qHZZ signal", 40, 100, 220);
  TH1F sig_qhzz_hist_mass_4e("sig_qhzz_hist_mass_4e", "Mass, 4e, qHZZ signal", 40, 100, 220);
  TH1F sig_qhzz_hist_mass_2e2m("sig_qhzz_hist_mass_2e2m", "Mass, 2e2m, qHZZ signal", 40, 100, 220);
...
float       HiggsMassPointInfo::massHigh = 220.;
...
std::string HiggsMassPointInfo::treeFolder = "/mnt/hadoop/user/sixie/ntuples/hzz4l/step2/HZZ4L_42X_S1_V04_S2_V01_adish/";

void doHZZHistograms_2011(char* filename) {

  HiggsMassPointInfo h120(120, 100, 135, 201, 251);

  analysisEngine(h120, filename);
}
