...
void doHZZHistograms_2011_cut(char* filename) {
  // filename = file where the histograms are saved to
  // low_cut = low cut for "mass" branch
  // high_cut = high cut for "mass" branch
